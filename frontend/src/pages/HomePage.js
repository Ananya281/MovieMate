    ...
    const fetchRecommendations = async () => {
      try {
        ...
        const [recommendedResponse, actionResponse, comedyResponse, romanceResponse, thrillerResponse] = await Promise.all([
          ...
          axios.get("http://localhost:5000/top_action_movies"),
          axios.get("http://localhost:5000/top_comedy_movies"),
          axios.get("http://localhost:5000/top_romance_movies"),
          axios.get("http://localhost:5000/top_thriller_movies"),
        ]);
